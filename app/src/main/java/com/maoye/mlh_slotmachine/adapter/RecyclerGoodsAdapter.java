...
public class RecyclerGoodsAdapter extends BaseRecyclerAdapter<GoodsBean> {
    ...
    public RecyclerView.ViewHolder onCreate(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_recyclergoods, parent, false);

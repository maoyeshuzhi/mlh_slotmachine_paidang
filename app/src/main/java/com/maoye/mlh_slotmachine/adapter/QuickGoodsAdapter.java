...
public class QuickGoodsAdapter extends BaseRecyclerAdapter<QuickOrderBean.SaledListBean> {
    @Override
    ...
    @Override
    public void onBind(RecyclerView.ViewHolder viewHolder, int RealPosition, QuickOrderBean.SaledListBean data, int size) {

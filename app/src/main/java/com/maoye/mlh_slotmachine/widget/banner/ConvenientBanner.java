...
public class ConvenientBanner<T> extends RelativeLayout {
    ...
    public ConvenientBanner(Context context, AttributeSet attrs) {
        ...
        autoTurningTime = a.getInteger(com.bigkoo.convenientbanner.R.styleable.ConvenientBanner_autoTurningTime, -1);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        viewPager = hView.findViewById(com.bigkoo.convenientbanner.R.id.cbLoopViewPager);

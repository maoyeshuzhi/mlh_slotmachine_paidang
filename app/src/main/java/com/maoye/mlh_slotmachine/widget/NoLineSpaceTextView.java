...
public class NoLineSpaceTextView extends android.support.v7.widget.AppCompatTextView {
    private MyTextViewInner textView;

    public NoLineSpaceTextView(Context context) {
        super(context);
        init(null, 0);
    }

    public NoLineSpaceTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public NoLineSpaceTextView(Context context, AttributeSet attrs, int defStyle) {
